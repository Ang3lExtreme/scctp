...
public class AzureManagement {
	...
	static final String MY_SUFFIX = "51162"; // Add your suffix here
	...
	static final String[] BLOB_CONTAINERS = { "images", "videos" };	// Containers to add to the blob storage
					...
					Thread th = new Thread(() -> {
						try {
							...
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "users", "/id",
									null);
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "auction", "/id",
									null);
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "bid", "/id",
									null);
